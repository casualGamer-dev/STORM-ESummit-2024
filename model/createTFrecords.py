...
#*******************************************************************************************************************
# Images folder
img_path = 'auto-layout/training_images/'
# Label map contains the classes to be detected
label_map_dict = label_map_util.get_label_map_dict('auto-layout/label_map.pbtxt')
# Using glob to read the images and xml contained in teh training images folder
images = sorted(glob.glob('auto-layout/training_images/*.jpg'))
xmls = sorted(glob.glob('auto-layout/training_images/*.xml'))
#printing values
...
train.to_csv('auto-layout/training_data/train.csv')
valid.to_csv('auto-layout/training_data/valid.csv')

print("Training data lenght: ", len(train))
print("Validation data lenght ", len(valid))

writer = tf.python_io.TFRecordWriter('auto-layout/records/train.record')
...
writer = tf.python_io.TFRecordWriter('auto-layout/records/valid.record')
# Call to the group image and their data function
