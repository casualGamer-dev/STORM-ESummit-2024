...
images_dir = os.getcwd() +  "/auto-layout/test_images"
frozen_graph = os.getcwd() + "/auto-layout/experiments/exported_model/frozen_inference_graph.pb"
labels_location = os.getcwd() + "/auto-layout/" + "label_map.pbtxt"
num_classes = 5

def main():
    print("Starting auto-layout...")
